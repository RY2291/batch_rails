...
UserScore.create(user_id: user2.id, score: 3, received_at: Time.current)
UserScore.create(user_id: user2.id, score: 2, received_at: Time.current)

UserScore.create(user_id: user3.id, score: 5, received_at: Time.current)
UserScore.create(user_id: user3.id, score: 5, received_at: Time.current)
UserScore.create(user_id: user3.id, score: 5, received_at: Time.current)

UserScore.create(user_id: user4.id, score: 0, received_at: Time.current)
UserScore.create(user_id: user4.id, score: 3, received_at: Time.current)
UserScore.create(user_id: user4.id, score: 0, received_at: Time.current)
